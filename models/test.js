...
const testSchema = new mongoose.Schema({
    ...
    kienthucvathongtin: {
      ...
      required: true,
      enum: [
        'Có kiến thức chuyên môn của nhân viên tiếp dân về các quy trình, quy định, dịch vụ và thông tin liên quan đến ủy ban nhân dân. Nhân viên nên có khả năng cung cấp thông tin chính xác và chi tiết cho người dân.',
